...
![图9-1-1. 自动机器学习的基本流程](./img/9-1-1-overview.png)
...
![图9-1-2. 随机搜索算法与网格搜索算法的示意图（TODO：重画）](./img/9-1-2-randomgrid.png)
...
![图9-1-3. SMBO的优化过程](./img/9-1-6-smbo.png)
...
![图9-1-4. 一个神经网络结构搜索空间的例子](./img/9-1-4-nasspace.png)
...
![图9-1-5. 一个搜索空间对应的超网络 ](./img/9-1-5-supernet.png)
...
![图9-1-6. 单发搜索的流程 ](./img/9-1-6-oneshot.png)
