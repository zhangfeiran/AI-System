...
![图5-1-1. 深度神经网络编译器架构图](./img/5-1-1-compiler.png)
...
![图5-1-2. 深度神经网络编译器架构图](./img/5-1-2-overview.png)
...
<!-- 
![图5-1-3. 深度学习计算中常用的算子 -->](./img/5-1-3-op.png)
:width:`350px`
...
![图5-1-5. 一个简单的计算图示例](./img/5-1-5-dag.png)
