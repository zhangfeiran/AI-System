...
![图1. 深度学习框架发展历程](./img/frameworks-evolution.png)
:width:`70%`
...
![图2. 基于数据流图的深度学习框架的基本组件](./img/framework-overview.png)
:width:`35%`
...
![图3. x*y+sin⁡(x)的数据流图实例和定义该数据流图的TensorFlow代码](./img/forward-computation-graph.png)
:width:`40%`
...
![图4. 二维张量和三维张量示意图](./img/tensor.png)
:width:`35%`
...
![图5. 对求值z的表达式树](./img/expression-tree-for-example.png)
:width:`10%`
...
![图6. 反向计算的数据流图实例](./img/backward-computation-graph.png)
:width:`20%`
...
![图7. 简单数据流图的串行执行调度](./img/op-schedule.png)
:width:`50%`
...
![图8. 基本的Inception模块执行策略](./img/inception-parallel-scheduling.png)
:width:`50%`
...
![图9. 数据流图切分和插入跨设备数据传输](./img/op-schedule-multi-devices.png)
:width:`40%`
