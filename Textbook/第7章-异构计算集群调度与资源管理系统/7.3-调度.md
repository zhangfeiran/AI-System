...
<center>图 7.3.5 2个作业的DRF调度实例  ([图片引用 Volcano](https://github.com/volcano-sh/volcano/blob/master/docs/design/drf.md))</center>
...
<center>图 7.3.8 虚拟集群和物理集群映射与绑定  ([图片引用 HiveD](https://www.usenix.org/sites/default/files/conference/protected-files/osdi20_slides_zhao.pdf))</center>
...
<center>图 7.3.9 虚拟集群资源分配  [图片引用 HiveD OSDI '20](https://dl.acm.org/doi/10.5555/3488766.3488795) </center>
...
<center>图 7.3.10 作业等待时间过长问题  [图片引用 Hortonworks Talk '15](https://www.slideshare.net/Hadoop_Summit/enabling-diverse-workload-scheduling-in-yarn) </center>
...
<center>图 7.3.11 抢占调度 [图片引用 Cloudera YARN Capacity Scheduler '15](https://blog.cloudera.com/better-slas-via-resource-preemption-in-yarns-capacityscheduler/)</center>
