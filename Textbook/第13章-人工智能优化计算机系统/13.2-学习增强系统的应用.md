...
![图13-2-1. Fugu 使用基于模型的强化学习算法。](./img/2/fugu.png)
:width:`400px`
...
![图13-2-2. Pensieve 的模型使用了 A3C。](./img/2/pensieve.png)
:width:`550px`
...
![图13-2-3. 学习索引的 Recursive Model Index (RMI)。](./img/2/recursive_learned_index.png)
:width:`550px`
...
![图13-2-4. 此图以高斯过程模型为例子，来展示 “系统设定与配置--性能” 的空间。。另外，Metis 在探索和利用的基础之上，也考虑了重采样来保证模型的训练质量。](./img/2/metis.png)
:width:`550px`
...
![图13-2-5. 芯片设计流程。芯片设计公司和EDA软件提供商正在尝试使用AI技术助力芯片设计的各个步骤。](./img/2/ic_flow.png)
:width:`550px`
...
![图13-2-6. 使用强化学习完成芯片设计中的布图规划。](./img/2/floorplan.png)
:width:`1000px`
...
![图13-2-7. Resource Central 的架构，包括了 Offline 组件（来负责数据的处理工作）和 Client 组件（来负责外部系统与 Resource Central 的通信）。](./img/2/resource_central.png)
:width:`475px`
